 ...
 * @author mlahi
 */
public class Edit_Financial_Transsaction_log extends javax.swing.JFrame {

        public Edit_Financial_Transsaction_log() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Edit Financial Transaction Log");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_Financial_Transsaction_log.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Edit_Financial_Transsaction_log().setVisible(true);
            }
        });
    }
